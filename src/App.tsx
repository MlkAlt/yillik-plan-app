  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/app" element={<AppLayout><AppHomeScreen planlar={planlar} aktifEntry={aktifEntry} onPlanEkle={handlePlanEkle} onSinifSec={handleSinifSec} syncing={syncing} tamamlananlar={tamamlananlar} onTamamlananGuncelle={handleTamamlananGuncelle} /></AppLayout>} />
